...
/*!<--------------------------------------------------------------------------------------------*/
#define ADDR_REG_PAGE				0xF0		/*!< Page register								*/
/*!<--------------------------------------------------------------------------------------------*/
...
/*!<--------------------------------------------------------------------------------------------*/
#define ADDR_REG_PAGE1_PWM(x)		(x)			/*!< PWMx Configure Register(x=0...197)			*/
#define ADDR_REG_PAGE2_SL(x)		(x)			/*!< SLx Configure Register(x=0...197)			*/
